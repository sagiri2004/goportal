 ...
 */
export const ServerRail = ({ activeServerId, onSelectServer = () => { }, onCreateServer = () => { }, onOpenGames = () => { }, servers: serversProp, }) => {
    ...
    return (_jsxs("aside", { className: "h-full w-[72px] bg-[hsl(240,10%,6%)] border-r border-border flex flex-col overflow-hidden", children: [_jsxs("div", { className: "flex flex-col items-center gap-3 py-3", children: [_jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", onClick: onCreateServer, className: "cursor-pointer w-12 h-12 rounded-[24px] hover:rounded-[16px] bg-secondary hover:bg-indigo-500 hover:text-white text-foreground transition-all duration-200", children: _jsx(Plus, { className: "h-5 w-5" }) }) }), _jsx(TooltipContent, { children: "Add Server" })] }), _jsx("div", { className: "w-8 mx-auto", children: _jsx(Separator, { className: "w-8" }) })] }), _jsx("div", { className: "flex-1 overflow-y-auto py-1 scrollbar-thin scrollbar-thumb-zinc-700 scrollbar-track-transparent", children: _jsx("div", { className: "flex flex-col items-center gap-2", children: servers.map((server) => {
                        ...
                        return (_jsxs("div", { className: "relative w-12 group", children: [_jsx("div", { className: [
                                    ...
                                    ].join(' ') }), _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx("button", { onClick: () => onSelectServer(server.id), className: `cursor-pointer w-12 h-12 flex items-center justify-center text-sm font-semibold transition-all duration-200 ${isActive
                                                    ? 'rounded-[16px] bg-indigo-500 text-white'
                                                    : 'rounded-[24px] bg-secondary text-foreground group-hover:bg-indigo-500 group-hover:text-white group-hover:rounded-[16px]'}`, type: "button", children: server.iconUrl ? (_jsx("img", { src: server.iconUrl, alt: server.name, className: "h-full w-full rounded-[inherit] object-cover" })) : (('initials' in server ? server.initials : undefined) ?? getServerInitials(server.name)) }) }), _jsx(TooltipContent, { children: server.name })] })] }, server.id));
                    }) }) }), _jsxs("div", { className: "flex flex-col items-center gap-2 py-3", children: [_jsx(Separator, { className: "w-8 mx-auto my-1" }), _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", onClick: onOpenGames, className: "cursor-pointer w-12 h-12 rounded-[24px] hover:rounded-[16px] hover:bg-indigo-500 hover:text-white text-foreground transition-all duration-200", children: _jsx(Gamepad2, { className: "h-5 w-5" }) }) }), _jsx(TooltipContent, { children: "Games" })] }), _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", className: "cursor-pointer w-12 h-12 rounded-[24px] hover:rounded-[16px] hover:bg-indigo-500 hover:text-white text-foreground transition-all duration-200", children: _jsx(Compass, { className: "h-5 w-5" }) }) }), _jsx(TooltipContent, { children: "Explore" })] }), _jsxs(Tooltip, { children: [_jsx(TooltipTrigger, { asChild: true, children: _jsx(Button, { variant: "ghost", size: "icon", className: "cursor-pointer w-12 h-12 rounded-[24px] hover:rounded-[16px] hover:bg-indigo-500 hover:text-white text-foreground transition-all duration-200", children: _jsx(Download, { className: "h-5 w-5" }) }) }), _jsx(TooltipContent, { children: "Download" })] })] })] }));
};
