...
import { Dialog, DialogContent, DialogDescription, DialogHeader, DialogTitle, Button, Input, Label, } from '@goportal/ui';
...
export const CreateServerModal = ({ isOpen, onOpenChange, defaultServerName, onCreate, onResolveInvitePreview, onJoinByInvite, initialInviteCode, }) => {
    ...
    return (_jsx(Dialog, { open: isOpen, onOpenChange: onOpenChange, children: _jsxs(DialogContent, { className: "max-w-md p-0 overflow-hidden", children: [_jsxs(DialogHeader, { className: "sr-only", children: [_jsx(DialogTitle, { children: "Tao hoac tham gia server" }), _jsx(DialogDescription, { children: "Hop thoai tao server moi hoac tham gia bang loi moi." })] }), _jsxs("div", { className: "relative min-h-[420px]", children: [_jsx("section", { className: [
