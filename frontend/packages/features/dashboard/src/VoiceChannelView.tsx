...
export const VoiceChannelView: React.FC = () => {
  ...
  return (
    <div className="flex h-full min-h-0">
      <div className="relative flex min-w-0 flex-1 flex-col bg-[hsl(240,10%,6%)]">
        ...
        <div className="flex h-[60px] items-center justify-center gap-2">
          <div className="flex items-center overflow-hidden rounded-md bg-[hsl(240,5%,18%)]">
            ...
            <Tooltip>
              <TooltipTrigger asChild>
                <button type="button" className="flex h-10 w-5 items-center justify-center border-l border-[hsl(240,4%,22%)] text-muted-foreground">
                  <ChevronDown className="h-3 w-3" />
                </button>
              </TooltipTrigger>
              <TooltipContent>Input Device</TooltipContent>
            </Tooltip>
          </div>
          ...
          <div className="flex items-center overflow-hidden rounded-md bg-[hsl(240,5%,18%)]">
            ...
            <Tooltip>
              ...
              <TooltipContent>Camera Device</TooltipContent>
            </Tooltip>
          </div>

          {[
            { icon: ArrowLeftRight, label: 'Activities' },
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button type="button" className="flex h-10 w-12 items-center justify-center rounded-md bg-red-500 text-white transition-colors hover:bg-red-600">
          ...
          <Tooltip>
            <TooltipTrigger asChild>
              <button type="button" className="flex h-8 w-8 items-center justify-center rounded-md text-muted-foreground hover:text-foreground">
      ...
      {showThread && (
        <aside className="flex h-full w-[360px] flex-none flex-col border-l border-border bg-[hsl(240,6%,10%)]">
