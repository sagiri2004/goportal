...
export const formatRelativeCountdown = (unixSeconds) => {
    if (!unixSeconds) {
...
export const getParticipantDisplayName = (participant) => participant.user?.username ?? participant.team?.name ?? 'TBD';
