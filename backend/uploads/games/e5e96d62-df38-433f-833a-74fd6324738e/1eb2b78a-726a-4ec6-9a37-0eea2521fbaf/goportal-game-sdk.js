...
var GoPortalSDKBundle = (() => {
  ...
  var GoPortalSDKClient = class {
    ...
    async shareRoom(payload) {
      return this.command("shareRoom", payload);
    }
    ...
    async listOpenRooms(payload = {}) {
      return this.command("listOpenRooms", payload);
    }
    ...
    get commands() {
      return {
        ...
        shareRoom: (payload) => this.command("shareRoom", payload),
        ...
        listOpenRooms: (payload) => this.command("listOpenRooms", payload ?? {}),
